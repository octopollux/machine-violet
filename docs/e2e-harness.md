...
| `tool_input:*` | `repaired`, `rejected` | Engine-side tool contract decisions. Includes tool, criticality, call context, and shape-only repair/issues; raw argument prose is omitted. |
