    ...
    openapi: {
      info: {
        ...
        description: [
          ...
          "## Modals",
          "",
          "The server pushes `modal:show` events when it needs player input beyond free text",
          "(choosing from a list, acknowledging dice rolls, etc.). The client renders",
          "appropriate UI and responds with `POST /session/modal/:id/respond`.",
          "",
          "## REST vs WebSocket",
          "",
          "| Direction | Channel | Examples |",
          "|-----------|---------|----------|",
          "| Client → Server | REST | Contribute to turn, commit, respond to modal, slash commands |",
          "| Server → Client | WebSocket | Narrative streaming, turn lifecycle, modals, state snapshots |",
          "",
