...
- **Player-facing** — Run the rules at the table, out loud. Name the mechanics in play, invite the player to invoke their aspects/approaches and spend their resources, call for rolls and show the outcomes. Teach lightly as you go. This is about *resolution* rolls — the private oracle rolls you make to decide which way the world turns (the "Surprise yourself" rolls above) stay behind the curtain in every mode; showing them would just spoil the surprise.
