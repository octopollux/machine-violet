 ...
 *
 * Lives in @machine-violet/shared because the client TUI also needs to resolve
 * wikilink targets to slugs for render-time tagging — and divergence between
 * client-computed and server-computed slugs would silently break navigation.
 *
