...
tui-rpg needs to import RPG sourcebooks (rulebooks and campaign books) from user-supplied files, primarily PDFs. These are complex, high-production-value documents with multi-column layouts, stat blocks, sidebars, tables, and decorative elements.
